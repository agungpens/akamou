...
let PermintaanPembelianKas = {
    module: () => {
        return "purchasing-kas/permintaan-pembelian-kas";
    },

    moduleApi: () => {
        return `api/${PermintaanPembelianKas.module()}`;
    },

    add: () => {
        window.location.href = url.base_url(PermintaanPembelianKas.module()) + "add?tipe=DOCT_PR";
        ...
        //                                     <a href="" class="text-success" onclick="PermintaanPembelianKas.addDoc(this, event)" tipe="DOCT_PR" data-id="">Masuk</a>
        //                                 </small>
        //                             </div>
        //                         </div>
        ...
        //                                 <small class="text-muted">
        //                                     <a href="" class="text-success"  onclick="PermintaanPembelianKas.addDoc(this, event)" tipe="DOCT_PR_INV" data-id="">Masuk</a>
        //                                 </small>
        //                             </div>
        //                         </div>
        //                         <div id="conversationChart"></div>
    ...
    addDoc: (elm, e) => {
        ...
        window.location.href = url.base_url(PermintaanPembelianKas.module()) + "add?tipe=" + tipe;
    },

    ubah: (elm) => {
        let data_id = $(elm).attr("data_id");
        window.location.href = url.base_url(PermintaanPembelianKas.module()) + "ubah?id=" + data_id;
    },

    detail: (elm) => {
        let data_id = $(elm).attr("data_id");
        window.location.href = url.base_url(PermintaanPembelianKas.module()) + "detail?id=" + data_id;
    },

    back: () => {
        window.location.href = url.base_url(PermintaanPembelianKas.module()) + "index";
    },
    ...
    getData: async () => {
        ...
        params.tgl_efektif_sampai = $("#tgl_efektif_sampai").val()
        ...
        if (tableData.length > 0) {
            ...
            tableData.DataTable({
                ...
                "ajax": {
                    "url": url.base_url(PermintaanPembelianKas.moduleApi()) + `getData`,
                    "type": "POST",
                    "data": params,
                },
                "deferRender": true,
                ...
                "columns": [
                    {
                        ...
                        "render": (data, type, row, meta) => {
                            let htmlAction = '';
                            if (updateAction == '1') {
                                htmlAction += `<i class="bx bx-edit" style="cursor: pointer;" data_id="${data}" onclick="PermintaanPembelianKas.detail(this)"></i>`;
                            }
                            return htmlAction;
                        }
                    },
    ...
    delete: (elm, e) => {
        ...
        <div class="col-12 text-center">
            <br/>
            <button class="btn btn-primary btn-sm" onclick="PermintaanPembelianKas.deleteConfirm(this, '${data_id}')">Ya</button>
    ...
    deleteConfirm: (elm, id) => {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: params,
            url: url.base_url(PermintaanPembelianKas.moduleApi()) + "delete",
    ...
    getPostData: () => {
        let data = {
            ...
            'data_item': PermintaanPembelianKas.getPostdataItem(),
            'data_lampiran': PermintaanPembelianKas.getPostdataLampiran(),
        };
    ...
    getPostTransfer: () => {
        let data = {
            ...
            'data_item': PermintaanPembelianKas.getPostdataItemTransfer(),
        };
        return data;
    },
    ...
    submit: (elm, e) => {
        ...
        let params = PermintaanPembelianKas.getPostData(tipe);
        ...
        if (validation.runWithElement(form)) {
            $.ajax({
                ...
                dataType: 'json',
                data: params,
                url: url.base_url(PermintaanPembelianKas.moduleApi()) + "submit",
                beforeSend: () => {
    ...
    getPostDataPrePR: () => {
        let data = {
            ...
            'data_item': PermintaanPembelianKas.getPostdataItemPrePR(),
            'data_lampiran': PermintaanPembelianKas.getPostdataLampiran(),
        };
    ...
    submitPrePR: (elm, e) => {
        ...
        if (validation.runWithElement(form)) {
            $.ajax({
                ...
                dataType: 'json',
                data: params,
                url: url.base_url(PermintaanPembelianKas.moduleApi()) + "submitPrePR",
                beforeSend: () => {
                    message.loadingProses('Proses Simpan Data...');
                },
                error: function () {
    ...
    reject: (elm, e) => {
        ...
        <div class="col-12 text-end">
            <br/>
            <button class="btn btn-primary btn-sm" onclick="PermintaanPembelianKas.rejectConfirm(this, '${data_id}')">Proses</button>
    ...
    // approve: (elm, e) => {
    //     e.preventDefault();
    //     let params = PermintaanPembelianKas.getPostData();
    //     // console.log(params);
    //     // return
    //     params.keterangan = '';
    //     $.ajax({
    ...
    //         dataType: 'json',
    //         data: params,
    //         url: url.base_url(PermintaanPembelianKas.moduleApi()) + "approve",
    //         beforeSend: () => {
    //             message.loadingProses('Proses Simpan Data...');
    //         },
    //         error: function () {
    ...
    approve:(elm)=>{
        ...
        html = `<div class="row">
            ...
            <div class="col-md-12 text-center">
                <br/>
                <button class="btn btn-primary btn-sm" onclick="PermintaanPembelianKas.approveConfirm('${id}', '${status}')">Ya</button>
                <button class="btn btn-sm" onclick="message.closeDialog()">Tidak</button>
            </div>
            </div>`;
        }
    ...
    transfer: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: params,
            url: url.base_url(PermintaanPembelianKas.moduleApi()) + "transfer",
            beforeSend: () => {
    ...
    getDataLogKaryawan: async () => {
        ...
        if (tableData.length > 0) {
            tableData.DataTable({
                ...
                "ajax": {
                    "url": url.base_url(PermintaanPembelianKas.moduleApi()) + `getDataLogKaryawan`,
                    "type": "GET",
                    "data": params
                    // "headers": {
    ...
    modulePerubahanApi: () => {
        return `api/${PermintaanPembelianKas.modulePerubahan()}`;
    },

    detailPerubahan: (elm) => {
        let data_id = $(elm).attr("data_id");
        let from_id = $('input#id').val();
        window.location.href = url.base_url(PermintaanPembelianKas.modulePerubahan()) + "ubah?id=" + data_id + "&state=karyawan-" + from_id;
    },
    ...
    showDetailEditProfile: (elm, e) => {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: params,
            url: url.base_url(PermintaanPembelianKas.modulePerubahanApi()) + "showDetailEditProfile",
    ...
    addItem: (elm, e) => {
        let i = PermintaanPembelianKas.indexItem
        e.preventDefault();
        ...
        let html = `<tr class="input" data_id="">
            ...
            <td>
                ...
                placeholder="Jumlah Barang" error="Jumlah Barang" value="" readonly/>
            </td>
            <td>
            ...
            <td>
                <div class="input-group">
                    <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="PermintaanPembelianKas.showDataVendor(this,'vendor_id${i}')">Pilih</button>
                    <input id="vendor_id" type="text" class="vendor_id${i} vendor form-control required" error="Vendor" placeholder="Pilih Data Vendor" aria-label="Pilih Data Vendor" aria-describedby="button-addon1">
                </div>
            </td>
            <td>
            ...
            <td>
                <div class="input-group">
                    <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="PermintaanPembelianKas.addFile(this)">Pilih</button>
            ...
            <td>
                <i class="bx bx-trash" style="cursor: pointer;" onclick="PermintaanPembelianKas.deleteItem(this, event)"></i>
            </td>
        </tr>`;
        tbody.prepend(html);
    ...
    addItemPrePr: (elm, e) => {
        ...
        let html = `<tr>
                        <td>
                            ...
                            <button onclick="PermintaanPembelianKas.showDataPengajuanPrePr(this, 'pre_pr_id${i}','nama_item${i}', 'jumlah${i}', 'est_biaya${i}', 'satuan${i}', 'vendor_id${i}', 'remarks${i}', 'img_file${i}' )" class="btn_add${i} btn btn-danger">Ambil</button>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="input-group">
                                <button src="" class="img_file${i} btn btn-outline-primary" type="button" id="button-addon1" onclick="PermintaanPembelianKas.showFile(this, event)">Lihat</button>
                            </div>
                        </td>
                        <td>
                            <i class="btn_del${i} bx bx-trash" style="cursor: pointer;" onclick="PermintaanPembelianKas.deleteItemPrePr(this, ${i})"></i>
                        </td>
                    </tr>`;
    ...
    addItemBarangJasa: (elm, e) => {
        ...
        let i = PermintaanPembelianKas.indexBarangJasa
        ...
        let html = `<tr class="input" data_id="">
            <td>
                <div class="input-group">
                    <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="PermintaanPembelianKas.showDataKaryawan(this,'bj_nik${i}')">Pilih</button>
            ...
            <td>
                <div class="input-group">
                    <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="PermintaanPembelianKas.showDataArea(this,'area${i}')">Pilih</button>
            ...
            <td>
                <div class="input-group">
                    <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="PermintaanPembelianKas.showDataJenis(this,'nama_item${i}')">Pilih</button>
        ...
        PermintaanPembelianKas.indexBarangJasa++;
    },
                ...
                html = `<div class="row g-3">
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <button onclick="PermintaanPembelianKas.imageZoomIn('#image-pembelian')" class="btn btn-primary">Zoom In</button>
                            <button onclick="PermintaanPembelianKas.imageZoomOut('#image-pembelian')" class="btn btn-danger">Zoom Out</button>
                        </div>
                    </div>
                </div>`;
            }else{
    ...
    barangDitolak: (elm) => {
        ...
        <div class="col-12 text-end">
            <br/>
            <button class="btn btn-primary btn-sm" onclick="PermintaanPembelianKas.rejectBarang(this, '${data_id}')">Proses</button>
            <button class="btn btn-sm" onclick="PermintaanPembelianKas.barangReceivedPop(this, '${data_id}')">Batal</button>
        </div>
        </div>`;
    ...
    //         dataType: 'html',
    //         data: params,
    //         url: url.base_url(PermintaanPembelianKas.moduleApi()) + "showDataPengajuanPrePr",
    ...
    //                 size: 'large'
    //             });
    //             PermintaanPembelianKas.getDataPengajuanPrePr(pre_pr_id, item_name, qty, satuan, remarks, img_file);
    //         }
    //     });
    ...
    showDataPengajuanPrePrItem: () => {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: params,
            url: url.base_url(PermintaanPembelianKas.moduleApi()) + "showDataPengajuanPrePrItem",
            ...
            success: function (resp) {
                ...
                PermintaanPembelianKas.getDataPengajuanPrePrItem();
            }
        });
    ...
    getDataPengajuanPrePrItem: async () => {
        ...
        if (tableData.length > 0) {
            tableData.DataTable({
                ...
                "ajax": {
                    "url": url.base_url('api/purchasing-kas/permintaan-pembelian-kas') + `getDataPengajuanPrePrItem`,
                    "type": "POST",
                    "data": params
                },
                "deferRender": true,
    ...
    pilihDataPengajuanPrePrItem: (elm) => {
        ...
        //                     <div class="input-group">
        //                         <button class="btn btn-outline-primary" type="button" id="button-addon1" onclick="PermintaanPembelianKas.showDataVendor(this,'vendor_id${i}')">Pilih</button>
        //                         <input id="vendor_id" name="vendor_id[${i}]" type="text" class="vendor_id${i} vendor form-control required" error="Vendor" placeholder="Pilih Data Vendor" aria-label="Pilih Data Vendor" aria-describedby="button-addon1">
        //                     </div>
        //                 </td>
        //                 <td>
        //                     <p>${remarks_val}</p>
        ...
        //                 <td>
        //                     <div class="input-group">
        //                         <button src="${url.base_url('public/pengajuan_pre_pr')}${img_file_val}" class="btn btn-outline-primary" type="button" id="button-addon1" onclick="PermintaanPembelianKas.showFile(this, event)">Lihat</button>
        //                     </div>
        //                 </td>
        //                 <td>
    ...
    showDataKaryawan: (elm,id_text) => {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: params,
            url: url.base_url(PermintaanPembelianKas.moduleApi()) + "showDataKaryawan",
            ...
            success: function (resp) {
                ...
                PermintaanPembelianKas.getDataKaryawan(id_text);
            }
        });
    ...
    showDataArea: (elm,id_text) => {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: params,
            url: url.base_url(PermintaanPembelianKas.moduleApi()) + "showDataArea",
            ...
            success: function (resp) {
                ...
                PermintaanPembelianKas.getDataArea(id_text);
            }
        });
    ...
    getDataArea: async (bindText) => {
        ...
        if (tableData.length > 0) {
            tableData.DataTable({
                ...
                "ajax": {
                    "url": url.base_url('api/purchasing-kas/permintaan-pembelian-kas') + `getDataArea`,
                    "type": "POST",
                    "data": params
                },
                "deferRender": true,
    ...
    showDataJenis: (elm,id_text) => {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: params,
            url: url.base_url(PermintaanPembelianKas.moduleApi()) + "showDataJenis",
            ...
            success: function (resp) {
                ...
                PermintaanPembelianKas.getDataJenis(id_text);
            }
        });
    ...
    getDataJenis: async (bindText) => {
        ...
        if (tableData.length > 0) {
            tableData.DataTable({
                ...
                "ajax": {
                    "url": url.base_url('api/purchasing-kas/permintaan-pembelian-kas') + `getDataJenis`,
                    "type": "POST",
                    "data": params
                },
                "deferRender": true,
    ...
    showDataVendor: (elm,id_text) => {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: params,
            url: url.base_url(PermintaanPembelianKas.moduleApi()) + "showDataVendor",
            ...
            success: function (resp) {
                ...
                PermintaanPembelianKas.getDataVendor(id_text);
            }
        });
    ...
    getDataVendor: async (bindText) => {
        ...
        if (tableData.length > 0) {
            tableData.DataTable({
                ...
                "ajax": {
                    "url": url.base_url('api/purchasing-kas/permintaan-pembelian-kas') + `getDataVendor`,
                    "type": "POST",
                    "data": params
                },
                "deferRender": true,
    ...
    showDataKodeItem: (elm,id_text) => {
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                PermintaanPembelianKas.getDataKodeItem(id_text);
            }
        });
...
$(function () {
    PermintaanPembelianKas.getData();
    PermintaanPembelianKas.getDataLogKaryawan();
    PermintaanPembelianKas.setDate();
    PermintaanPembelianKas.select2All();
});
