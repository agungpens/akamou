...
let Pengguna = {
    ...
    ubah: (elm) => {
        ...
        window.location.href = url.base_url(Pengguna.module()) + "ubah?id=" + data_id;
    },
    ...
    detailPerubahan: (elm) => {
        ...
        window.location.href = url.base_url(Pengguna.modulePerubahan()) + "ubah?id=" + data_id + "&state=karyawan-" + from_id;
    },
    ...
    showDetailEditProfile:(elm, e)=>{
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: params,
            url: url.base_url(Pengguna.modulePerubahanApi()) + "showDetailEditProfile",
