                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="mb-3" action="{{ route('signin') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" id="cekLogin">Sign
                                    in</button>
                            </div>
                        </form>
...
<script>
    ...
    $('#cekLogin').click(function(e) {
        ...
        if (username == '' || password == '') {
            // alert toastr in center top
            toastr.warning('Username atau Password tidak boleh kosong', 'Perhatian', {
