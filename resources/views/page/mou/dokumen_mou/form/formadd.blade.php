            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-3">
                            <button class="btn btn-outline-primary" type="button" id="button-addon1"
                                onclick="DokumenMou.takeFile(this, event)">Pilih</button>
                            <input id="file_doc" src="" type="text" class="form-control required"
                                ...
                                onclick="DokumenMou.viewFileWithModal(this,event)" readonly>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="text-end mt-3 mb-3">
                        @if (isset($data->id))
                            <button class="btn btn-primary me-2" onclick="DokumenMou.viewFile(this, event)"
