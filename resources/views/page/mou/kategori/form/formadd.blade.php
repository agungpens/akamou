...
<div class="row">
    <div class="col-md-12 text-end">
        <a href="{{ url('kategori-mou') }}" class="dt-button create-new btn btn-secondary" tabindex="0"
...
<div class="col-xl-12">
    <div class="card">
        <h5 class="card-header">Form Kategori Mou</h5>
        <!-- Account -->
        <form id="form-kategori" method="POST" action="{{ url('kategori-mou/submit') }}">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control required" name="nama_kategori" id="nama_kategori"
                                ...
                                value="{{ isset($data->nama_kategori) ? $data->nama_kategori : '' }}" />
                        </div>
                    </div>
