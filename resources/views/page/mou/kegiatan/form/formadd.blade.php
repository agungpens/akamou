...
<div class="row">
    <div class="col-md-12 text-end">
        <span class="dt-button create-new btn btn-secondary" tabindex="0" aria-controls="DataTables_Table_0"
...
<div class="col-xl-12">
    <div class="card">
        <h5 class="card-header">Form Kegiatan Dokumen</h5>
        <!-- Account -->
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control required" name="nama_level" id="nama_level"
                                error="Nama level" id="basic-icon-default-fullname" placeholder="Nama Kegiatan"
